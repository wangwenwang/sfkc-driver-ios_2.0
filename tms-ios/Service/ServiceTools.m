...
- (void)timingTracking:(NSString *)cellphone andLon:(double)lon andLat:(double)lat andVehicleLocation:(NSString *)vehicleLocation  {
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@", kApi, @"kc-transport/tmsApp/timingTracking"];
...
//    NSDictionary * dicParams = @{@"cellphone": cellphone,
//                                 @"userName": @"",
...
//                                 @"uuid": @"iOS",
//                                 @"code": @"",
//                                 @"brightscreen": _app.displayStatus,
//                                 @"charging": charging,
//                                 @"os": os};
//22
    NSLog(@"上传位置点参数加密前：%@", params);
    //
    NSString * aesParamString = [AESConvertHelper convertToAesWithParam:params];
